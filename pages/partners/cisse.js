...
export default function Academic() {
  ...
  return (
    <Layout title='PISCES | CISSE' background='other'>
      <Heading size='lg' mb={3}>CISSE</Heading>
      <Heading size='md' >The Colloquium For Information Systems Security Education</Heading>
