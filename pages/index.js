...
export default function Index({ allPosts }) {
  ...
  return (
    <Layout title='PISCES'>
      <Box minH={isMobile ? '70vh' : ''}>
        <Heading fontSize={isMobile ? '1.3em' : '2em'} pt={isMobile ? '20vh' : '1.2em'} fontWeight={500}>Public Infrastructure Security Cyber Education System</Heading>
