export const data = [
  ...
  },
  {
    ...
    text: `PISCES trains a future workforce of entry-level cyber analysts to meet with ever-growing demand for businesses to adapt to and protect against dynamic cyber threats. Municipalities and communities facing similar vulnerabilities need these services but in many cases are unable to secure the resources to meet their needs. For municipalities, collaboration with universities and students helps them meet these needs and remain protected.`
  },
  {
  ...
  },
  {
    ...
    text: `PISCES now ships all collectors with a network tap to avoid situations in which customers lack networking switches capable of spanning or mirroring ports. Deploying the collector with the tap will cause an approximately 10-second network outage.`
  },
  {
    title: `Can a data sharing partner get access to the intrusion detection system services or alerts?`,
    text: `No, but if the data sharing partner has specific questions, the students can be tasked with obtaining the necessary data.`
  },
  {
  ...
  {
    title: `How do we maintain the security of data?`,
    text: `
